...
public final class LocalJndiServerModule implements Module {
    ...
    public void configure(Binder binder) {
        binder.bind(JndiContextProvider.class).to(LocalJndiServer.class).asEagerSingleton();
        binder.bind(JndiContextBinderUtility.class).to(JnpContextBinderUtility.class).in(Singleton.class);
    }
